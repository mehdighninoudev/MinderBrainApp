               ...
               Container(   
                    ...
                    Column (children: [
                     ...
                     /* Center(child: Text("Nom: " + patient.patientName ,  style: TextStyle(fontSize: 18.0)),
                      ...
                      StreamBuilder<DatabaseEvent>(stream: patientRef != null ? patientRef!.onValue : null, 
          builder: (context, snapshot){
            if(snapshot.hasData && !snapshot.hasError){
              var event = snapshot.data as DatabaseEvent;
              var snapshot2 = event.snapshot.value;
              if(snapshot2 == null) {
                return Center(child:Text("Pas de patient ajoute"),);
              }
            ...
            // Map<String, dynamic> map = new Map<String, dynamic>.from(json.decode(snapshot2 as String));
              ...
              for(var patientMap in map.values){
                ...
                /*if(){
                 ...
                 PatientModel patientModel = PatientModel.fromMap(Map<String, dynamic>.from(patientMap));
              ...
              return Padding(
                ...
                child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: patients.length,itemBuilder: (context, index){
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      Text("Mr ${patient.patientName}", style: TextStyle(color: Colors.black)),
                ...
                ,
                  ...
                  Container(   
                      ...
                      child: Column(children: [
                        ...
                        SingleChildScrollView(child: StreamBuilder<DatabaseEvent>(stream: taskRef != null ? taskRef!.onValue : null, 
          builder: (context, snapshot){
            if(snapshot.hasData && !snapshot.hasError){
              var event = snapshot.data as DatabaseEvent;
              var snapshot2 = event.snapshot.value;
